    ...
    return (
        <div className="search-params">
            <div className="search-params__select-wrapper">
                <DropdownSelect value={category} options={CATEGORIES_ARRAY} onChange={setCategory} />
            </div>
            <div className="search-params__select-wrapper">
                <DropdownSelect value={language} options={LANGUAGES_ARRAY} onChange={setLanguage} />
            </div>
            <div className="search-params__select-wrapper">
                <DropdownSelect value={country} options={COUNTRIES_ARRAY} onChange={setCountry} />
            </div>
            <button className="button" disabled={disabled} onClick={dispatchChange}>
                Apply parameters
            </button>
        </div>
    );
